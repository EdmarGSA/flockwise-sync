...
import { ArrowLeft, Target, Package, MessageSquare, Bird, Pill, Scissors, Scale, Calendar, Skull, Thermometer, FileText } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background pb-6">
      ...
      <main className="px-4 pt-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Button
            variant="outline"
            onClick={() => navigate(`/veterinario/${lote.id}/relatorio-diario`)}
            className="h-20 flex-col gap-1 bg-card hover:bg-accent/50 col-span-2"
          >
            <FileText className="w-6 h-6 text-blue-600" />
            <span className="text-sm font-medium">Relatório Diário + IA</span>
          </Button>
        </div>
      </main>
