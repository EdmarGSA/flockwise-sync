...
const ProdutoEditForm = ({ produto, userId, categorias, gruposProduto, gruposAnimal, fasesAnimal, onSuccess }: ProdutoEditFormProps) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      embalagem_primaria: produto.embalagem_primaria || "",
      embalagem_secundaria: produto.embalagem_secundaria || "",
      unidade_compra: produto.unidade_compra || "UN",
      embalagem_quantidade: Number(produto.embalagem_quantidade) || 1,
      fator_conversao: Number(produto.fator_conversao) || 1,
      requer_quarentena: produto.requer_quarentena ?? true,
      status_comercial: produto.status_comercial || "consumo",
    },
  });
