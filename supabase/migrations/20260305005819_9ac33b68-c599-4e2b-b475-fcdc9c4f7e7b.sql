...
BEGIN
  ...
  INSERT INTO public.silos (integrado_id, nome, diametro_m, numero_pernas, numero_aneis, capacidade_volume_m3, fator_tonelada_m3, ativo)
  VALUES (p_integrado_id, 'Silo 01', 3.5, 4, 20, 25, 0.6, true) RETURNING id INTO v_silo_01;
  INSERT INTO public.silos (integrado_id, nome, diametro_m, numero_pernas, numero_aneis, capacidade_volume_m3, fator_tonelada_m3, ativo)
  VALUES (p_integrado_id, 'Silo 02', 3.5, 4, 20, 25, 0.6, true) RETURNING id INTO v_silo_02;
  INSERT INTO public.silos (integrado_id, nome, diametro_m, numero_pernas, numero_aneis, capacidade_volume_m3, fator_tonelada_m3, ativo)
  VALUES (p_integrado_id, 'Silo 03', 4.0, 4, 25, 35, 0.6, true) RETURNING id INTO v_silo_03;
  INSERT INTO public.silos (integrado_id, nome, diametro_m, numero_pernas, numero_aneis, capacidade_volume_m3, fator_tonelada_m3, ativo)
  VALUES (p_integrado_id, 'Silo 04', 3.0, 4, 15, 18, 0.6, true) RETURNING id INTO v_silo_04;

  INSERT INTO public.nucleos (integrado_id, area_id, nome, tipo_producao, cep, logradouro, bairro, cidade, estado, ativo)
  VALUES (p_integrado_id, v_area_norte, 'Núcleo A1', 'frango_corte', '85000-000', 'Estrada Rural KM 5', 'Zona Rural', 'Guarapuava', 'PR', true) RETURNING id INTO v_nucleo_a1;
  INSERT INTO public.nucleos (integrado_id, area_id, nome, tipo_producao, cep, logradouro, bairro, cidade, estado, ativo)
  VALUES (p_integrado_id, v_area_norte, 'Núcleo A2', 'frango_corte', '85000-001', 'Estrada Rural KM 8', 'Zona Rural', 'Guarapuava', 'PR', true) RETURNING id INTO v_nucleo_a2;
  INSERT INTO public.nucleos (integrado_id, area_id, nome, tipo_producao, cep, logradouro, bairro, cidade, estado, ativo)
  VALUES (p_integrado_id, v_area_sul, 'Núcleo B1', 'frango_corte', '85100-000', 'Rod. BR-277 KM 340', 'Distrito Industrial', 'Pinhão', 'PR', true) RETURNING id INTO v_nucleo_b1;
  INSERT INTO public.nucleos (integrado_id, area_id, nome, tipo_producao, cep, logradouro, bairro, cidade, estado, ativo)
  VALUES (p_integrado_id, v_area_oeste, 'Núcleo C1', 'postura', '85200-000', 'Linha São José KM 3', 'Interior', 'Candói', 'PR', true) RETURNING id INTO v_nucleo_c1;

  -- Galpões (bebedouro_tipo: niple/tacas, comedouro_tipo: manual/automatico)
  ...
  VALUES (v_nucleo_a1, v_silo_01, 'Galpão 1', 150, 14, 3, 'niple', 800, 'automatico', 160, 'positiva', 24, 4, 2, true) RETURNING id INTO v_galpao_1;
  INSERT INTO public.galpoes (nucleo_id, silo_id, nome, comprimento, largura, altura, bebedouro_tipo, bebedouro_quantidade, comedouro_tipo, comedouro_quantidade, tipo_pressao, ventilador_quantidade, caixa_agua_quantidade, silo_quantidade, ativo)
  VALUES (v_nucleo_a1, v_silo_02, 'Galpão 2', 150, 14, 3, 'niple', 800, 'automatico', 160, 'positiva', 24, 4, 2, true) RETURNING id INTO v_galpao_2;
  INSERT INTO public.galpoes (nucleo_id, silo_id, nome, comprimento, largura, altura, bebedouro_tipo, bebedouro_quantidade, comedouro_tipo, comedouro_quantidade, tipo_pressao, ventilador_quantidade, caixa_agua_quantidade, silo_quantidade, ativo)
  VALUES (v_nucleo_a2, v_silo_03, 'Galpão 3', 180, 16, 3.5, 'niple', 1000, 'automatico', 200, 'negativa', 32, 6, 3, true) RETURNING id INTO v_galpao_3;
  INSERT INTO public.galpoes (nucleo_id, silo_id, nome, comprimento, largura, altura, bebedouro_tipo, bebedouro_quantidade, comedouro_tipo, comedouro_quantidade, tipo_pressao, ventilador_quantidade, caixa_agua_quantidade, silo_quantidade, ativo)
  VALUES (v_nucleo_b1, v_silo_04, 'Galpão 4', 120, 12, 2.8, 'niple', 600, 'manual', 120, 'positiva', 16, 3, 1, true) RETURNING id INTO v_galpao_4;
  ...
  VALUES (v_nucleo_c1, 'Galpão Postura 1', 100, 10, 3, 'niple', 500, 'automatico', 100, 'positiva', 12, 2, 1, true) RETURNING id INTO v_galpao_postura;
  ...
  INSERT INTO public.lotes (integrado_id, nucleo_id, galpao_id, quantidade_aves, data_prevista_alojamento, data_alojamento, data_prevista_saida, status, linhagem, sexo, peso_medio_pintinhos)
  VALUES (p_integrado_id, v_nucleo_a2, v_galpao_3, 30000, (CURRENT_DATE - 7)::date, (CURRENT_DATE - 7)::date, (CURRENT_DATE + 35)::date, 'alojado', 'cobb_500', 'macho', 0.043) RETURNING id INTO v_lote_7d;
  INSERT INTO public.lotes (integrado_id, nucleo_id, galpao_id, quantidade_aves, data_prevista_alojamento, status, linhagem, sexo)
  VALUES (p_integrado_id, v_nucleo_b1, v_galpao_4, 20000, (CURRENT_DATE + 5)::date, 'previsao', 'hubbard', 'femea');
  ...
  VALUES (p_integrado_id, v_lote_28d, 0.042, 0.195, 0.520, 0.980, 1.550, 2.200, 2.900, 0.068),
  ...
  INSERT INTO public.pesagem_itens (pesagem_id, quantidade_aves, peso_bruto_g, peso_tara_g, peso_liquido_g) VALUES (v_pesagem_id, 25, 5.375, 0.5, 4.875), (v_pesagem_id, 25, 5.375, 0.5, 4.875);
  ...
  INSERT INTO public.pesagem_itens (pesagem_id, quantidade_aves, peso_bruto_g, peso_tara_g, peso_liquido_g) VALUES (v_pesagem_id, 25, 13.5, 0.5, 13.0), (v_pesagem_id, 25, 13.5, 0.5, 13.0);
  ...
  INSERT INTO public.pesagem_itens (pesagem_id, quantidade_aves, peso_bruto_g, peso_tara_g, peso_liquido_g) VALUES (v_pesagem_id, 25, 25.0, 0.5, 24.5), (v_pesagem_id, 25, 25.0, 0.5, 24.5);
  ...
  INSERT INTO public.pesagem_itens (pesagem_id, quantidade_aves, peso_bruto_g, peso_tara_g, peso_liquido_g) VALUES (v_pesagem_id, 25, 39.25, 0.5, 38.75), (v_pesagem_id, 25, 39.25, 0.5, 38.75);
  ...
  INSERT INTO public.pesagem_itens (pesagem_id, quantidade_aves, peso_bruto_g, peso_tara_g, peso_liquido_g) VALUES (v_pesagem_id, 25, 5.5, 0.5, 5.0), (v_pesagem_id, 25, 5.5, 0.5, 5.0);
  ...
  INSERT INTO public.pesagem_itens (pesagem_id, quantidade_aves, peso_bruto_g, peso_tara_g, peso_liquido_g) VALUES (v_pesagem_id, 25, 13.75, 0.5, 13.25), (v_pesagem_id, 25, 13.75, 0.5, 13.25);
  ...
  INSERT INTO public.pesagem_itens (pesagem_id, quantidade_aves, peso_bruto_g, peso_tara_g, peso_liquido_g) VALUES (v_pesagem_id, 25, 5.45, 0.5, 4.95), (v_pesagem_id, 25, 5.45, 0.5, 4.95);
  ...
  VALUES (p_integrado_id, 'Ração Inicial Premium', v_grupo_racao, v_cat_inicial, 'kg', 2.50, 5000, 1000, true),
  ...
  INSERT INTO public.metas_zootecnicas (integrado_id,
    mortalidade_7_dias_ok, mortalidade_7_dias_alerta, mortalidade_14_dias_ok, mortalidade_14_dias_alerta,
    mortalidade_21_dias_ok, mortalidade_21_dias_alerta, mortalidade_28_dias_ok, mortalidade_28_dias_alerta,
    mortalidade_35_dias_ok, mortalidade_35_dias_alerta, mortalidade_42_dias_ok, mortalidade_42_dias_alerta,
    ca_7_dias_ok, ca_7_dias_alerta, ca_14_dias_ok, ca_14_dias_alerta,
    ca_21_dias_ok, ca_21_dias_alerta, ca_28_dias_ok, ca_28_dias_alerta,
    ca_35_dias_ok, ca_35_dias_alerta, ca_42_dias_ok, ca_42_dias_alerta
  ) VALUES (p_integrado_id,
    0.50, 1.00, 0.80, 1.50, 1.20, 2.00, 1.50, 2.50, 2.00, 3.00, 2.50, 3.50,
    0.90, 1.10, 1.20, 1.40, 1.35, 1.55, 1.48, 1.68, 1.60, 1.80, 1.70, 1.90
