...
BEGIN
  ...
  -- Núcleos (cep, logradouro, bairro, cidade, estado são NOT NULL)
  ...
  VALUES (p_integrado_id, v_nucleo_a1, v_galpao_1, 25000, (CURRENT_DATE - 28)::date, (CURRENT_DATE - 28)::date, (CURRENT_DATE + 14)::date, 'alojado', 'cobb_500', 'misto', 0.042)
  RETURNING id INTO v_lote_28d;
  INSERT INTO public.lotes (integrado_id, nucleo_id, galpao_id, quantidade_aves, data_prevista_alojamento, data_alojamento, data_prevista_saida, status, linhagem, sexo, peso_medio_pintinhos)
  VALUES (p_integrado_id, v_nucleo_a1, v_galpao_2, 24000, (CURRENT_DATE - 14)::date, (CURRENT_DATE - 14)::date, (CURRENT_DATE + 28)::date, 'alojado', 'ross_308', 'misto', 0.044)
  RETURNING id INTO v_lote_14d;
  INSERT INTO public.lotes (integrado_id, nucleo_id, galpao_id, quantidade_aves, data_prevista_alojamento, data_alojamento, data_prevista_saida, status, linhagem, sexo, peso_medio_pintinhos)
  VALUES (p_integrado_id, v_nucleo_a2, v_galpao_3, 30000, (CURRENT_DATE - 7)::date, (CURRENT_DATE - 7)::date, (CURRENT_DATE + 35)::date, 'alojado', 'cobb_500', 'macho', 0.043)
